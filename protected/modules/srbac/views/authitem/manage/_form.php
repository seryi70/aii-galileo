...
<div class="srbacForm">
    ...
    <div class="simple">
        ...
        $model->name == Helper::findModule('srbac')->superUser ?
            array('size'    => 20,
                  'disabled'=> "disabled") : array('size'=> 20)); ?>
    </div>
    <div class="simple">
    ...
    <div class="simple">
        ...
        <?php echo SHtml::activeTextArea($model, 'description', array('rows'=> 3,
                                                                      'cols'=> 20)); ?>
    </div>
    ...
    <div class="simple">
        ...
        $model->name == Helper::findModule('srbac')->superUser ?
            array('rows'    => 3,
                  'cols'    => 20,
                  'disabled'=> 'disabled') : array('rows'=> 3,
                                                   'cols'=> 20)); ?>
    </div>
    <div class="simple">
