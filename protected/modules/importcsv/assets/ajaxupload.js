...
(function ($) {
    ...
    Ajax_upload.prototype = {
        ...
        create_wrapper:function () {
            ...
            setTimeout(function () {
                wrapper.css({
                    position:'relative', display:'block', overflow:'hidden', height:button.outerHeight(true), width:button.outerWidth(true)
                });
            }, 1);
            ...
            wrapper.mousemove(function (e) {
                ...
                self.input.css({
                    top:e.pageY - wrapper.offset().top - 5 + 'px', left:e.pageX - wrapper.offset().left - 170 + 'px'
                });
            });
        ...
        create_input:function () {
            ...
            this.input =
                $('<input type="file" />')
                    ...
                    .css({
                        'position':'absolute', 'margin':0, 'padding':0, 'width':'220px', 'heigth':'10px', 'opacity':0
                    })
                    .change(function () {
                        if ($(this).val() == '') {
                            // there is no file
        ...
        create_form:function () {
            ...
            this.form =
                $('<form method="post" enctype="multipart/form-data"></form>')
                    .appendTo('body')
                    .attr({
                        "action":this.settings.action, "target":this.iframe.attr('name')
                    });
            ...
            for (var i in this.settings.data) {
                $('<input type="hidden" />')
                    .appendTo(this.form)
                    .attr({
                        'name':i, 'value':this.settings.data[i]
                    });
            }
        },
