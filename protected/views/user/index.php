            ...
            'buttons'  => array(
                'user_delete' => array(
                    ...
                    'options'  => array("class" => "fan_del",
                                        'title' => Yii::t('admin_user', 'Delete')), // HTML options for the button   tag
                ),
                'user_update' => array(
                    ...
                    'options'  => array("class" => "fan_update",
                                        'title' => Yii::t('admin_user', 'Update')), // HTML options for the    button tag
                ),
                'user_view'   => array(
                    ...
                    'options'  => array("class" => "fan_view",
                                        'title' => Yii::t('admin_user', 'View')), // HTML options for the    button tag
                )
            ),
