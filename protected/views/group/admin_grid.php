                    ...
                    'buttons'  => array(
                        'planet_delete' => array(
                            ...
                            'options'  => array("class" => "fan_del",
                                                'title' => Yii::t('admin_product1', 'Delete')), // HTML options for the button   tag
                        ),
                        'planet_update' => array(
                            ...
                            'options'  => array("class" => "fan_update",
                                                'title' => Yii::t('admin_product1', 'Update')), // HTML options for the    button tag
                        ),
                        'planet_view'   => array(
                            ...
                            'options'  => array("class" => "fan_view",
                                                'title' => Yii::t('admin_product1', 'View')), // HTML options for the    button tag
                        )
                    ),
