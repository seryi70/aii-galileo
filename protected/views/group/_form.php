...
<div id="form_wrapper" class="client-val-form">
    ...
    <?php   if ($_POST['create_root'] == 'true' && $model->isNewRecord) : ?>        <h3 id="create_header"><span
    style="color:#4079C8">Create New Root Group</span></h3>


    <?php elseif ($model->isNewRecord) : ?>    <h3 id="create_header"><span
    style="color:#4079C8">Create New Group</span></h3>

    <?php elseif (!$model->isNewRecord): ?>    <h3 id="update_header">Update Group <span style="color:#4079C8"></span>
</h3>
