...
<div id="satellite_form_con" class="client-val-form">
    ...
    <?php   if ($model->isNewRecord) : ?>    <h3 id="create_header"><span
    style="color:#4079C8">Create New Satellite</span></h3>
    <?php elseif (!$model->isNewRecord): ?>    <h3 id="update_header"> Update Satellite <span style="color:#4079C8">with ID: <?php echo
$model->id;  ?></h3>
    ...
    ', NULL, array('class' => 'errorsum notification errorshow png_bg')); ?>    <p class="note">Fields with <span
        ...
        <div class="row">
            ...
            <?php echo $form->textField($model, 'address', array('size'     => 45,
                                                                 'maxlength'=> 45)); ?>
        ...
        <div class="row">
            ...
            <?php echo $form->textField($model, 'deactivateDate', array('size'     => 19,
                                                                        'maxlength'=> 19)); ?>
