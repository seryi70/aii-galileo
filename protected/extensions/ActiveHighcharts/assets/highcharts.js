...
(function () {
    ...
    function wc(a, b) {
        ...
        function h(a) {
            ...
            Nb && (La || (gb = null, o(xa, function (a) {
                ...
                if (a.isDirtyExtremes)a.isDirtyExtremes =
                    !1, aa(a, "afterSetExtremes", a.getExtremes());
        ...
        function Z() {
            ...
            if (b.enabled && !m.credits)c = b.href, m.credits = I.text(b.text, 0, 0).on("click",
                function () {
        ...
        var q = v.chart, y = q.margin, y = mb(y) ? y : [y, y, y, y], T = p(q.marginTop, y[0]), w = p(q.marginRight, y[1]), E = p(q.marginBottom, y[2]), bb = p(q.marginLeft, y[3]), ia = q.spacingTop, ua = q.spacingRight, R = q.spacingBottom, jb = q.spacingLeft, ib, $, ja, J, ba, M, O, pa, Ja, C, D, na, za, Ca, sa, ra, $a, Za, ma, Na, Sa, da, m = this, kb = (y = q.events) && !!y.click,
            ...
            function d(b) {
                ...
                if (!m) {
                    ...
                    b.legendItem = m = I.text(f.labelFormatter.call(b), 0, 0, f.useHTML).css(b.visible ? n : q).on("mouseover",
                        function () {
                            b.setState(ta);
                            m.css(l)
                        }).on("mouseout",
        ...
        Wb = function () {
            ...
            rb();
            if ((m.title || m.subtitle) && !s(T))(g = W(m.title && !$.floating &&
                !$.verticalAlign && $.y || 0, m.subtitle && !ja.floating && !ja.verticalAlign && ja.y || 0)) && (J = W(J, g + p($.margin, 15) + ia));
    ...
    var X, x = document, ca = window, oa = Math, z = oa.round, Ta = oa.floor, Yb = oa.ceil, W = oa.max, Ua = oa.min, Ba = oa.abs, ja = oa.cos, C = oa.sin, da = oa.PI, Dc = da * 2 / 360, kb = navigator.userAgent, Qb = /msie/i.test(kb) && !ca.opera, Xa = x.documentMode === 8, Ec = /AppleWebKit/.test(kb), Bc = /Firefox/.test(kb), Pb = !!x.createElementNS &&
    ...
    Sa.prototype = {init:function (a, b) {
        ...
        if (Ab(a))c = a, h === "circle" ? c = {x:"cx", y:"cy"}[c] || c : c === "strokeWidth" && (c = "stroke-width"), o = A(g, c) || this[c] || 0, c !== "d" && c !== "visibility" &&
            ...
            this.symbolName && /^(x|y|r|start|end|innerR|anchorX|anchorY)/.test(c) && (n || (this.symbolAttr(a), n = !0), k =
                !0);
    ...
    if (!Pb && !Fa)$a = {init:function (a, b) {
        ...
        b ? (a = a.replace("/>", ' xmlns="urn:schemas-microsoft-com:vml" />'), a = a.indexOf('style="') ===
            -1 ? a.replace("/>", ' style="display:inline-block;behavior:url(#default#VML);" />') : a.replace('style="', 'style="display:inline-block;behavior:url(#default#VML);')) : a = a.replace("<", "<hcv:");
        return a
    ...
    $.prototype = {isCartesian:!0, type:"line", pointClass:lb, sorted:!0, pointAttrToOptions:{stroke:"lineColor", "stroke-width":"lineWidth", fill:"fillColor", r:"radius"}, init:function (a, b) {
        ...
        if (l && !this.isDirty &&
            !i.isDirty && !this.yAxis.isDirty && !a)return!1;
        ...
        select:function (a) {
            ...
            h ? h.attr({d:c}) : a.tracker = f.path(c).attr({isTracker:!0, stroke:Gc, fill:Ma, "stroke-linejoin":"bevel", "stroke-width":b.lineWidth + 2 * g, visibility:a.visible ? eb : ab}).on(Ga ? "touchstart" : "mouseover",
                function () {
                    if (e.hoverSeries !==
                        a)a.onMouseOver()
                }).on("mouseout",
    ...
    var zb = pa($, {type:"column", tooltipOutsidePlot:!0, pointAttrToOptions:{stroke:"borderColor", "stroke-width":"borderWidth", fill:"color", r:"borderRadius"}, init:function () {
        ...
        o(a.points, function (h) {
            ...
            if (h.y !== null)e ? e.attr(d) : h.tracker = c[h.shapeType](d).attr({isTracker:f, fill:Gc, visibility:a.visible ? eb : ab}).on(Ga ? "touchstart" : "mouseover",
                function (c) {
    ...
    w = pa($, {type:"scatter", sorted:!1, translate:function () {
        ...
        a._hasTracking ? a._hasTracking =
            !0 : a.group.attr({isTracker:!0}).on(Ga ? "touchstart" : "mouseover",
            function (b) {
                a.onMouseOver();
