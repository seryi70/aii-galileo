    ...
    <div class="content-box-header">
       <h2><?php echo $this->modelClass;?>s</h2><br>
        ...
        <a   class='headerlinks' href="<?php echo '<?php echo '; ?>$this->createUrl('index_list');<?php echo '?>'; ?>">Frontend ListView</a>
         <br>
        <p>Right click on a <?php echo $this->class2var($this->modelClass);?> node  for details.Click on a <?php echo $this->class2var($this->modelClass);?> node  to filter <?php echo  $relatedModelClass; ?> records.</p>
    </div>
