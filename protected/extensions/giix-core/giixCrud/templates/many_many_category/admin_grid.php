...
")<?php echo ';?>'; ?>
        ...
        <div class="search-form hide">
            <?php echo '<?php '; ?>$this->renderPartial('application.views.<?php echo  $this->class2var($relatedModelClass);?>._search', array(
                                                                                 'model' => $model,
                                                                            )); <?php echo '?>'; ?>
        </div>
        <!-- search-form -->
     ...
     <?php echo '<?php  '; ?>
        ...
        $del_con = Yii::t('admin_<?php echo  $this->class2var($relatedModelClass); ?>', 'Are you sure you want to delete this <?php echo  $this->class2var($relatedModelClass); ?>?');
...
?>
    array(
       'class' => 'CDataColumn',
       'type' => 'image',
       'value' => '($data-><?php echo  $this->class2var($relatedModelClass);?>ImgBehavior->getFileUrl("small"))?$data-><?php echo  $this->class2var($relatedModelClass);?>ImgBehavior->getFileUrl("small")."?".time() :Yii::app()->baseUrl."/img/placeholder_50.jpg". "?".time()',
    ),
    array(
        'class' => 'CButtonColumn',
        'buttons' => array(
            '<?php echo  $this->class2var($relatedModelClass);?>_delete' => array(
                'label' => Yii::t('admin_<?php echo  $this->class2var($relatedModelClass);?>', 'Delete'), // text label of the button
            ...
            '<?php echo  $this->class2var($relatedModelClass);?>_update' => array(
                'label' => Yii::t('admin_<?php echo  $this->class2var($relatedModelClass);?>', 'Update'), // text label of the button
                'url' => '$data->id', // a PHP expression for generating the URL of the button
            ...
            '<?php echo  $this->class2var($relatedModelClass);?>_view' => array(
                'label' => Yii::t('admin_<?php echo  $this->class2var($relatedModelClass);?>', 'View'), // text label of the button
                'url' => '$data->id', // a PHP expression for generating the URL of the button
        ...
        'template' => '{<?php echo  $this->class2var($relatedModelClass);?>_view}{<?php echo  $this->class2var($relatedModelClass);?>_update}{<?php echo  $this->class2var($relatedModelClass);?>_delete}',
    ),
    ),
