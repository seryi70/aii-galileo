...
(function () {
        ...
        var p = s.chart, Y = p.margin, Y = xb(Y) ? Y : [Y, Y, Y, Y], qa = r(p.marginTop, Y[0]), M = r(p.marginRight, Y[1]), w = r(p.marginBottom, Y[2]), N = r(p.marginLeft,
            ...
            function d(b) {
                ...
                if (!n) {
                    ...
                    b.legendItem = n =
                        T.text(f.labelFormatter.call(b), 0, 0, f.useHTML).css(b.visible ? l : p).on("mouseover",
                            function () {
                                b.setState(fb);
                                n.css(m)
                            }).on("mouseout",
    ...
    ia.prototype = {isCartesian:!0, type:"line", pointClass:ab, sorted:!0, pointAttrToOptions:{stroke:"lineColor", "stroke-width":"lineWidth", fill:"fillColor", r:"radius"}, init:function (a, b) {
        ...
        remove:function (a, b) {
            ...
            h ? h.attr({d:c}) : a.tracker = f.path(c).attr({isTracker:!0, stroke:Qc, fill:Ka, "stroke-linejoin":"bevel", "stroke-width":b.lineWidth + 2 * g, visibility:a.visible ? $a : Xa}).on(Fa ? "touchstart" : "mouseover",
                function () {
    ...
    var jc = ea(ia, {type:"column", tooltipOutsidePlot:!0, pointAttrToOptions:{stroke:"borderColor", "stroke-width":"borderWidth", fill:"color", r:"borderRadius"}, init:function () {
        ...
        drawPoints:function () {
            ...
            q(a.points, function (h) {
                ...
                if (h.y !== null)e ? e.attr(d) : h.tracker = c[h.shapeType](d).attr({isTracker:f, fill:Qc, visibility:a.visible ? $a : Xa}).on(Fa ? "touchstart" : "mouseover",
                    function (c) {
    ...
    w = ea(ia, {type:"scatter", sorted:!1, translate:function () {
        ...
        a._hasTracking ? a._hasTracking = !0 : a.group.attr({isTracker:!0}).on(Fa ? "touchstart" : "mouseover",
            function (b) {
                a.onMouseOver();
                if (b.target._i !==
    ...
    Highcharts.RangeSelector = function (a) {
        ...
        return{render:function (c, l) {
            ...
            g || (v = f.text(j.rangeSelectorZoom, D, a.plotTop - 10).css(p.labelStyle).add(), C = D + v.getBBox().width + 5, q(x, function (c, d) {
                s[d] = f.button(c.text, C, a.plotTop - 25,
                    function () {
                        b(d, c);
                        this.isActive = !0
