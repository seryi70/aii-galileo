         ...
         'htmlOptions'=>array('class'=>'grid-view clear'),
          ...
          $count = 0;
              ...
              if ($count >= 7)
                  echo "\t\t*/\n";
              ?>
//TODO: Rearrange the ParentView column
    array('class' => 'CButtonColumn',
        ...
        'buttons' => array(
             'planet_view' => array(
                  ...
                  //'viewButtonUrl'=>'Yii::app()->createUrl("/planet/view", array("id" => $data->parentPlanetID))',
                   )
                  ),
 ...
 //PARENT VIEW
    $('.parent_view').each(function(index) {
        ...
        $(this).bind('click', function() {
            $.ajax({
                type: "POST",
                //TODO:verify planet is the parent on next line
                url: "<?php echo '<?php echo '; ?>Yii::app()->request->baseUrl;<?php echo '?>'; ?>/<?php echo $this->class2id($this->modelClass); ?>planet/returnView",
