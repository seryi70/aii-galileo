...
<div id="<?php echo $this->class2id($this->modelClass); ?>_form_con" class="client-val-form">
    ...
    <h3 id="update_header"> Update <?php echo $this->modelClass;?> <span  style="color:#4079C8">with ID: <?php echo '<?php '; ?>echo 
...
//CS: Install || Update time
    <div class="row">
        ...
        <span id="<?php echo '<?php '; ?> if ($model->isNewRecord) {
